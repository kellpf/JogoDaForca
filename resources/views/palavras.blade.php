...
<body>
    ...
    <div class="container">
            ...
            <div class="col-2">
                <button type="button" class="btn btn-dark">
                    <a class="nav-link" href="{{route('nova_palavra', ['id'=>$id])}}" style=" color: white;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="26" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
        ...
        <div class="justify-content-center d-flex col-10 mt-3">
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#id</th>
